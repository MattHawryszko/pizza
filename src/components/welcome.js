...
render() {
    return (
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-6 col-lg-4 thumb-img">
        ...
        <div className="row flex-column-reverse flex-md-row">
          ...
          <h2>Reservation</h2>
            <p>Call now to book a Reservation. We are available every day from 11 am onward (928) 222 - 0394</p>
          </div>
          <div className="col-12 col-md-6 col-lg-8 thumb-img">
